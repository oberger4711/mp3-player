...
public class TrackFileInfoProvider {
    ...
    public static List<TrackFileInfo> queryAlbumTracks(final Context context, final int albumId) {
        ...
        String selection = MediaStore.Audio.Media.ALBUM_ID + "=" + Integer.toString(albumId);
